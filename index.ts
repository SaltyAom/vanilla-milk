        ...
        class VanillaMilk extends HTMLElement {
            ...
            static get observedAttributes() {
                ...
                Object.entries(hooks).forEach(([name, hook]) => {
                    if (hook.type === "hookProp") observedProps.push(name)
                })
                ...
                execution(
                    (domString: string) => {
                        let [
                            parsedDomString,
                            eventMap
                        ]: any = this.parseDomString(domString)
            ...
            milkDom(
                ...
                let isInit = typeof displayed === "undefined",
                    templateBeforeDiff = template.cloneNode(
                        true
                ...
                textDiff.forEach(
                    (text, index) =>
                        (displayed.childNodes[index].textContent =
                            textDiff[index])
                )
                ...
                if (
                    ...
                    this.milkDom(
                        displayed,
                        templateBeforeDiff,
                        displayedChild.length - templateChildBeforeDiff.length >
                            1
                    )
            }
